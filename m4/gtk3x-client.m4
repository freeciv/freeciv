...
[
  ...
  if test "x$gui_gtk3x" = "xyes" ||
    ...
    PKG_CHECK_MODULES([GTK3X], [gtk+-3.0 >= 3.10.0],
      [
        GTK3X_CFLAGS="$GTK3X_CFLAGS -DGDK_VERSION_MIN_REQUIRED=GDK_VERSION_3_8"
        GTK3X_CFLAGS="$GTK3X_CFLAGS -DGLIB_VERSION_MIN_REQUIRED=GLIB_VERSION_2_36"
        gui_gtk3x=yes
