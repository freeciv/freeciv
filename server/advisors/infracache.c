...
static adv_want adv_calc_irrigate_transform(const struct city *pcity,
                                            const struct tile *ptile);
static adv_want adv_calc_mine_transform(const struct city *pcity,
                                        const struct tile *ptile);
static adv_want adv_calc_transform(const struct city *pcity,
                                   const struct tile *ptile);
static adv_want adv_calc_extra(const struct city *pcity, const struct tile *ptile,
                               const struct extra_type *pextra);
static adv_want adv_calc_rmextra(const struct city *pcity, const struct tile *ptile,
                                 const struct extra_type *pextra);

/**************************************************************************
  Calculate the benefit of irrigating the given tile.

  The return value is the goodness of the tile after the irrigation.
...
/**************************************************************************
  ...
  The return value is the goodness of the tile after the mining.
  This should be compared to the goodness of the tile currently.
  (see city_tile_value(); note that this depends on the AI's weighting
  values).
**************************************************************************/
