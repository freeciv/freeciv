...
./autogen.sh CFLAGS="-O3" --disable-nls --enable-client=gtk3,qt,sdl2 --enable-fcmp=cli,gtk3,qt --enable-freeciv-manual=html --enable-ai-static=classic,threaded,tex --prefix=${HOME}/freeciv/ && make -s -j$(nproc)
