...
./autogen.sh CFLAGS="-O3" --disable-nls --enable-client=gtk3,qt --disable-fcmp --enable-freeciv-manual=html --enable-ai-static=classic,threaded --prefix=${HOME}/freeciv/ && make -s -j$(nproc)
