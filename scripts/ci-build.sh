...
mkdir build
cd build
meson .. -Dprefix=${HOME}/freeciv/meson -Ddebug=true -Dack_experimental=true -Dclients='gtk3.22','qt','sdl2','gtk4' -Dfcmp='gtk3','qt','cli','gtk4' -Dqtver=qt5
ninja
ninja install
;;
...
../autogen.sh \
 ...
 --disable-fcdb \
 --with-qtver=qt6 \
 --enable-client=gtk3.22,gtk3,qt,sdl2,gtk4,stub \
