...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_player_save, "tai", pplayer, file, plrno);
}
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_player_load, "tai", pplayer, file, plrno);
}
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_city_save, "tai", file, pcity, citystr);
}
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_city_load, "tai", file, pcity, citystr);
}
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_unit_save, "tai", file, punit, unitstr);
}
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_unit_load, "tai", file, punit, unitstr);
}
