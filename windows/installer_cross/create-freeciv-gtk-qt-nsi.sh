...
# ./create-freeciv-gtk-qt-nsi.sh <Freeciv files directory> <version> <gui id> <gui name> <win32|win64|win> [mp gui] [exe id] [uninstall setup script]
