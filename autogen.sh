...
real_package_name "automake" "ftp://ftp.gnu.org/pub/gnu/automake/" 1 10 || DIE=1
...
real_package_name "glibtoolize" "ftp://ftp.gnu.org/pub/gnu/libtool/" 1 5 2 "0" || DIE=1
LIBTOOLIZE=$REALPKGNAME
real_package_name "python3" "https://www.python.org/" || DIE=1

if [ "$FC_USE_NLS" = "yes" ]; then
  DIE2=0
  version_check 1 "xgettext" "xgettext" "ftp://ftp.gnu.org/pub/gnu/gettext/" 0 14 || DIE2=1
  version_check 1 "msgfmt" "msgfmt" "ftp://ftp.gnu.org/pub/gnu/gettext/" 0 14 || DIE2=1
  if [ "$DIE2" -eq 1 ]; then
    echo 
