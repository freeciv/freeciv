...
cat <<EOF
  ...
  CreateShortCut "\$SMPROGRAMS\\\$STARTMENU_FOLDER\Freeciv Modpack Installer.lnk" "\$INSTDIR\freeciv-modpack.cmd" "\$DefaultLanguageCode" "\$INSTDIR\freeciv-modpack.exe" 0 SW_SHOWMINIMIZED
