...
cat <<EOF
  ...
  CreateShortCut "\$SMPROGRAMS\\\$STARTMENU_FOLDER\Freeciv.lnk" "\$INSTDIR\freeciv-gtk2.cmd" "\$DefaultLanguageCode" "\$INSTDIR\freeciv-gtk2.exe" 0 SW_SHOWMINIMIZED
...
Function RunFreeciv
  nsExec::Exec '"\$INSTDIR\freeciv-gtk2.cmd" \$DefaultLanguageCode'
FunctionEnd
