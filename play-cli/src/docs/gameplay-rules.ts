/**
 * `play/docs/gameplay.md`, verbatim — the static rules `rules` prints.
 *
 * Same contract as {@link ./play-card.ts}: `@cat docs/gameplay.md`
 * (justfile:402-403) copied byte for byte, trailing newline supplied by the
 * printer, drift caught by `test/docs-surfaces.test.ts`.
 *
 * Generated content — edit `play/docs/gameplay.md` and re-copy, never this file
 * alone.
 */
export const GAMEPLAY_RULES: string = `# Classic strategic-v1 gameplay
