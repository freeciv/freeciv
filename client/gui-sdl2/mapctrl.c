...
void popup_minimap_window(void)
{
  ...
  pOptions_Button->info_label = create_utf8_from_char_fonto(buf, FONTO_ATTENTION);
...
void popup_newcity_dialog(struct unit *pUnit, const char *pSuggestname)
{
  ...
  /* Create window */
  pstr = create_utf8_from_char_fonto(_("Build City"), FONTO_ATTENTION);
  pstr->style |= TTF_STYLE_BOLD;
  pWindow = create_window_skeleton(NULL, pstr, 0);
  ...
  pCancel_Button =
      create_themeicon_button_from_chars_fonto(
                                         current_theme->Small_CANCEL_Icon,
  ...
  pEdit = create_edit(NULL, pWindow->dst,
                      create_utf8_from_char_fonto(pSuggestname, FONTO_ATTENTION),
