...
"*diplomatdialog.*.button5.label:     Poison City",
"*diplomatdialog.*.button5.fromVert:  dlabel",
"*diplomatdialog.*.button5.fromHoriz: button4",
"*diplomatdialog.*.button6.label:     Cancel",
"*diplomatdialog.*.button6.fromVert:  button0",
