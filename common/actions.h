...
#define SPECENUM_VALUE112 ACTION_TELEPORT_CONQUER
#define SPECENUM_VALUE112NAME "Teleport Conquer"
#define SPECENUM_VALUE113 ACTION_CLEAN
#define SPECENUM_VALUE113NAME "Clean"
