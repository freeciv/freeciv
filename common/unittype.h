...
#define SPECENUM_VALUE76NAME N_("?unitflag:BarbarianBuildTech")
/* barbarian leader */
#define SPECENUM_VALUE77 L_BARBARIAN_LEADER
#define SPECENUM_VALUE77NAME N_("?unitflag:BarbarianLeader")
/* sea raider unit */
#define SPECENUM_VALUE78 L_BARBARIAN_SEA
#define SPECENUM_VALUE78NAME N_("?unitflag:BarbarianSea")
/* sea raider unit, global tech required */
#define SPECENUM_VALUE79 L_BARBARIAN_SEA_TECH
#define SPECENUM_VALUE79NAME N_("?unitflag:BarbarianSeaTech")
/* can found cities */
#define SPECENUM_VALUE80 L_CITIES
#define SPECENUM_VALUE80NAME N_("?unitflag:Cities")
/* can improve terrain */
#define SPECENUM_VALUE81 L_SETTLERS
#define SPECENUM_VALUE81NAME N_("?unitflag:Settlers")
/* loss results in loss of game */
#define SPECENUM_VALUE82 L_GAMELOSS
#define SPECENUM_VALUE82NAME N_("?unitflag:GameLoss")
/* can do diplomat actions */
#define SPECENUM_VALUE83 L_DIPLOMAT
#define SPECENUM_VALUE83NAME N_("?unitflag:Diplomat")
/* AI hunter type unit */
#define SPECENUM_VALUE84 L_HUNTER
#define SPECENUM_VALUE84NAME N_("?unitflag:Hunter")
