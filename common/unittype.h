...
#define SPECENUM_VALUE34 UTYF_NEWCITY_GAMES_ONLY
#define SPECENUM_VALUE34NAME N_("?unitflag:NewCityGamesOnly")
...
#define SPECENUM_VALUE67NAME N_("?unitflag:FirstBuild")
/* initial explorer unit */
#define SPECENUM_VALUE68 L_EXPLORER
#define SPECENUM_VALUE68NAME N_("?unitflag:Explorer")
/* can be found in hut */
...
#define SPECENUM_VALUE71NAME N_("?unitflag:Partisan")
/* ok on defense (AI) */
#define SPECENUM_VALUE72 L_DEFEND_OK
#define SPECENUM_VALUE72NAME N_("?unitflag:DefendOk")
/* primary purpose is defense (AI) */
#define SPECENUM_VALUE73 L_DEFEND_GOOD
#define SPECENUM_VALUE73NAME N_("?unitflag:DefendGood")
/* is useful for ferrying (AI) */
#define SPECENUM_VALUE74 L_FERRYBOAT
#define SPECENUM_VALUE74NAME N_("?unitflag:FerryBoat")
/* barbarians unit, land only */
#define SPECENUM_VALUE75 L_BARBARIAN
#define SPECENUM_VALUE75NAME N_("?unitflag:Barbarian")
/* barbarians unit, global tech required */
#define SPECENUM_VALUE76 L_BARBARIAN_TECH
#define SPECENUM_VALUE76NAME N_("?unitflag:BarbarianTech")
/* barbarian boat */
#define SPECENUM_VALUE77 L_BARBARIAN_BOAT
#define SPECENUM_VALUE77NAME N_("?unitflag:BarbarianBoat")
/* what barbarians should build */
#define SPECENUM_VALUE78 L_BARBARIAN_BUILD
#define SPECENUM_VALUE78NAME N_("?unitflag:BarbarianBuild")
/* barbarians build when global tech */
#define SPECENUM_VALUE79 L_BARBARIAN_BUILD_TECH
#define SPECENUM_VALUE79NAME N_("?unitflag:BarbarianBuildTech")
/* barbarian leader */
#define SPECENUM_VALUE80 L_BARBARIAN_LEADER
#define SPECENUM_VALUE80NAME N_("?unitflag:BarbarianLeader")
/* sea raider unit */
#define SPECENUM_VALUE81 L_BARBARIAN_SEA
#define SPECENUM_VALUE81NAME N_("?unitflag:BarbarianSea")
/* sea raider unit, global tech required */
#define SPECENUM_VALUE82 L_BARBARIAN_SEA_TECH
#define SPECENUM_VALUE82NAME N_("?unitflag:BarbarianSeaTech")
/* Startunit: Cities */
#define SPECENUM_VALUE83 L_START_CITIES
#define SPECENUM_VALUE83NAME N_("?unitflag:CitiesStartunit")
/* Startunit: Worker */
#define SPECENUM_VALUE84 L_START_WORKER
#define SPECENUM_VALUE84NAME N_("?unitflag:WorkerStartunit")
/* Startunit: Explorer */
#define SPECENUM_VALUE85 L_START_EXPLORER
#define SPECENUM_VALUE85NAME N_("?unitflag:ExplorerStartunit")
/* Startunit: King */
#define SPECENUM_VALUE86 L_START_KING
#define SPECENUM_VALUE86NAME N_("?unitflag:KingStartunit")
/* Startunit: Diplomat */
#define SPECENUM_VALUE87 L_START_DIPLOMAT
#define SPECENUM_VALUE87NAME N_("?unitflag:DiplomatStartunit")
/* Startunit: Ferryboat */
#define SPECENUM_VALUE88 L_START_FERRY
#define SPECENUM_VALUE88NAME N_("?unitflag:FerryStartunit")
/* Startunit: DefendOk */
#define SPECENUM_VALUE89 L_START_DEFEND_OK
#define SPECENUM_VALUE89NAME N_("?unitflag:DefendOkStartunit")
/* Startunit: DefendGood */
#define SPECENUM_VALUE90 L_START_DEFEND_GOOD
#define SPECENUM_VALUE90NAME N_("?unitflag:DefendGoodStartunit")
/* Startunit: AttackFast */
#define SPECENUM_VALUE91 L_START_ATTACK_FAST
#define SPECENUM_VALUE91NAME N_("?unitflag:AttackFastStartunit")
/* Startunit: AttackStrong */
#define SPECENUM_VALUE92 L_START_ATTACK_STRONG
#define SPECENUM_VALUE92NAME N_("?unitflag:AttackStrongStartunit")
/* AI hunter type unit */
#define SPECENUM_VALUE93 L_HUNTER
#define SPECENUM_VALUE93NAME N_("?unitflag:Hunter")
/* can improve terrain */
#define SPECENUM_VALUE94 L_SETTLERS
#define SPECENUM_VALUE94NAME N_("?unitflag:Settlers")
