...
#define SPECENUM_VALUE74NAME N_("?unitflag:AttackFast")
/* powerful attacking unit (Catapult..) (unused) */
#define SPECENUM_VALUE75 L_ATTACK_STRONG
#define SPECENUM_VALUE75NAME N_("?unitflag:AttackStrong")
...
#define SPECENUM_VALUE85NAME N_("?unitflag:Cities")
/* can improve terrain */
#define SPECENUM_VALUE86 L_SETTLERS
#define SPECENUM_VALUE86NAME N_("?unitflag:Settlers")
/* loss results in loss of game */
#define SPECENUM_VALUE87 L_GAMELOSS
#define SPECENUM_VALUE87NAME N_("?unitflag:GameLoss")
/* can do diplomat actions */
#define SPECENUM_VALUE88 L_DIPLOMAT
#define SPECENUM_VALUE88NAME N_("?unitflag:Diplomat")
/* AI hunter type unit */
#define SPECENUM_VALUE89 L_HUNTER
#define SPECENUM_VALUE89NAME N_("?unitflag:Hunter")
