...
static struct actres act_results[ACTRES_LAST] = {
  ...
  { ACT_TGT_COMPL_SIMPLE, ABK_NONE,          /* ACTRES_PARADROP_CONQUER */
    FALSE, ACTIVITY_LAST }, /* TODO: Should this be hostile? */
