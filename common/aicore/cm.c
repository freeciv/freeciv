...
/****************************************************************************
  Return positive value if tile a is better or equal to tile b in
  all categories, negative value if tile b is better to tile a in
  all categories, otherwise zero.
