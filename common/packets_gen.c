...
static struct packet_game_info *receive_packet_game_info_100(struct connection *pc, enum packet_type type)
{
  ...
  real_packet->simultaneous_phases = BV_ISSET(fields, 9);
  if (BV_ISSET(fields, 10)) {
    {
      int readin;
  ...
  real_packet->autoattack = BV_ISSET(fields, 45);
  real_packet->spacerace = BV_ISSET(fields, 46);
  ...
  real_packet->savepalace = BV_ISSET(fields, 50);
  real_packet->natural_city_names = BV_ISSET(fields, 51);
  real_packet->turnblock = BV_ISSET(fields, 52);
  real_packet->fixedlength = BV_ISSET(fields, 53);
  real_packet->auto_ai_toggle = BV_ISSET(fields, 54);
  real_packet->fogofwar = BV_ISSET(fields, 55);
  ...
  real_packet->happyborders = BV_ISSET(fields, 58);
  real_packet->slow_invasions = BV_ISSET(fields, 59);
  ...
  if (BV_ISSET(fields, 65)) {
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->firepower_factor = readin;
    }
  }
...
static int send_packet_game_info_100(struct connection *pc, const struct packet_game_info *packet)
{
  ...
  if(differ) {different++;}
  if(packet->simultaneous_phases) {BV_SET(fields, 9);}
  ...
  if(differ) {different++;}
  if(packet->autoattack) {BV_SET(fields, 45);}

  differ = (old->spacerace != real_packet->spacerace);
  if(differ) {different++;}
  if(packet->spacerace) {BV_SET(fields, 46);}
  ...
  differ = (old->watchtower_extra_vision != real_packet->watchtower_extra_vision);
  if(differ) {different++;}
  ...
  differ = (old->firepower_factor != real_packet->firepower_factor);
  if(differ) {different++;}
  ...
  /* field 46 is folded into the header */
  if (BV_ISSET(fields, 47)) {
  ...
  if (BV_ISSET(fields, 65)) {
    dio_put_uint8(&dout, real_packet->firepower_factor);
  }
  if (BV_ISSET(fields, 66)) {
...
static struct packet_player_info *receive_packet_player_info_100(struct connection *pc, enum packet_type type)
{
  ...
  real_packet->is_observer = BV_ISSET(fields, 3);
...
static int send_packet_player_info_100(struct connection *pc, const struct packet_player_info *packet)
{
  ...
  if(differ) {different++;}
  if(packet->is_observer) {BV_SET(fields, 3);}
...
BV_DEFINE(packet_ruleset_game_100_fields, 15);
...
static struct packet_ruleset_game *receive_packet_ruleset_game_100(struct connection *pc, enum packet_type type)
{
  ...
  if (BV_ISSET(fields, 3)) {
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->req_array_size = readin;
    }
  }
  if (BV_ISSET(fields, 4)) {
  ...
  if (BV_ISSET(fields, 6)) {
    
    {
      ...
      if(real_packet->bonus_array_size > SP_MAX * O_MAX) {
        freelog(LOG_ERROR, "packets_gen.c: WARNING: truncation array");
        real_packet->bonus_array_size = SP_MAX * O_MAX;
      }
      for (i = 0; i < real_packet->bonus_array_size; i++) {
        {
      int readin;
  ...
  if (BV_ISSET(fields, 7)) {
    
    {
      ...
      if(real_packet->req_array_size > SP_MAX * MAX_NUM_REQS) {
        freelog(LOG_ERROR, "packets_gen.c: WARNING: truncation array");
        real_packet->req_array_size = SP_MAX * MAX_NUM_REQS;
      }
      ...
      dio_get_uint8(&din, &readin);
      real_packet->specialist_req_type[i] = readin;
    }
      }
    }
  }
  if (BV_ISSET(fields, 8)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->specialist_req_range[i] = readin;
    }
      }
    }
  }
  ...
  if (BV_ISSET(fields, 10)) {
    
    {
      ...
      for (i = 0; i < real_packet->req_array_size; i++) {
        dio_get_bool8(&din, &real_packet->specialist_req_survives[i]);
      }
    }
  }
  if (BV_ISSET(fields, 11)) {
...
static int send_packet_ruleset_game_100(struct connection *pc, const struct packet_ruleset_game *packet)
{
  ...
  differ = (old->req_array_size != real_packet->req_array_size);
  if(differ) {different++;}
  if(differ) {BV_SET(fields, 3);}
  ...
  if(differ) {BV_SET(fields, 6);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < real_packet->req_array_size; i++) {
          if (old->specialist_req_type[i] != real_packet->specialist_req_type[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 7);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < real_packet->req_array_size; i++) {
          if (old->specialist_req_range[i] != real_packet->specialist_req_range[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 8);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < real_packet->req_array_size; i++) {
          if (old->specialist_req_value[i] != real_packet->specialist_req_value[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 9);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < real_packet->req_array_size; i++) {
          if (old->specialist_req_survives[i] != real_packet->specialist_req_survives[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if (BV_ISSET(fields, 3)) {
    dio_put_uint8(&dout, real_packet->req_array_size);
  }
  if (BV_ISSET(fields, 4)) {
  ...
  if (BV_ISSET(fields, 7)) {
  
    {
      ...
      for (i = 0; i < real_packet->req_array_size; i++) {
        dio_put_uint8(&dout, real_packet->specialist_req_type[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 8)) {
  
    {
      ...
      for (i = 0; i < real_packet->req_array_size; i++) {
        dio_put_uint8(&dout, real_packet->specialist_req_range[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 9)) {
  ...
  if (BV_ISSET(fields, 10)) {
  
    {
      ...
      for (i = 0; i < real_packet->req_array_size; i++) {
        dio_put_bool8(&dout, real_packet->specialist_req_survives[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 11)) {
...
BV_DEFINE(packet_ruleset_government_100_fields, 23);
...
static struct packet_ruleset_government *receive_packet_ruleset_government_100(struct connection *pc, enum packet_type type)
{
  ...
  if (BV_ISSET(fields, 6)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->unit_upkeep_factor[i] = readin;
    }
      }
    }
  }
  ...
  if (BV_ISSET(fields, 8)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->free_upkeep[i] = readin;
    }
      }
    }
  }
  if (BV_ISSET(fields, 9)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->output_before_penalty[i] = readin;
    }
      }
    }
  }
  if (BV_ISSET(fields, 10)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->celeb_output_before_penalty[i] = readin;
    }
      }
    }
  }
  if (BV_ISSET(fields, 11)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->output_inc_tile[i] = readin;
    }
      }
    }
  }
  if (BV_ISSET(fields, 12)) {
    
    {
      ...
      dio_get_uint8(&din, &readin);
      real_packet->celeb_output_inc_tile[i] = readin;
    }
      }
    }
  }
...
static int send_packet_ruleset_government_100(struct connection *pc, const struct packet_ruleset_government *packet)
{
  ...
  if(differ) {BV_SET(fields, 5);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->unit_upkeep_factor[i] != real_packet->unit_upkeep_factor[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 7);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->free_upkeep[i] != real_packet->free_upkeep[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 8);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->output_before_penalty[i] != real_packet->output_before_penalty[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 9);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->celeb_output_before_penalty[i] != real_packet->celeb_output_before_penalty[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 10);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->output_inc_tile[i] != real_packet->output_inc_tile[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if(differ) {BV_SET(fields, 11);}
...

    {
      ...
      if(!differ) {
        int i;
        for (i = 0; i < O_MAX; i++) {
          if (old->celeb_output_inc_tile[i] != real_packet->celeb_output_inc_tile[i]) {
            differ = TRUE;
            break;
          }
        }
  ...
  if (BV_ISSET(fields, 6)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->unit_upkeep_factor[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 7)) {
  ...
  if (BV_ISSET(fields, 8)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->free_upkeep[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 9)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->output_before_penalty[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 10)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->celeb_output_before_penalty[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 11)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->output_inc_tile[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 12)) {
  
    {
      ...
      for (i = 0; i < O_MAX; i++) {
        dio_put_uint8(&dout, real_packet->celeb_output_inc_tile[i]);
      }
    } 
  }
  if (BV_ISSET(fields, 13)) {
