...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_nationality(char *buf, size_t bufsz,
                                 struct player *pplayer,
                                 const struct requirement *preq,
                                 const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_original_owner(char *buf, size_t bufsz,
                                    struct player *pplayer,
                                    const struct requirement *preq,
                                    const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_diplrel(char *buf, size_t bufsz,
                             struct player *pplayer,
                             const struct requirement *preq,
                             const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_diplrel_tile(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_diplrel_tile_o(char *buf, size_t bufsz,
                                    struct player *pplayer,
                                    const struct requirement *preq,
                                    const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_diplrel_unit_any(char *buf, size_t bufsz,
                                      struct player *pplayer,
                                      const struct requirement *preq,
                                      const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_diplrel_unit_any_o(char *buf, size_t bufsz,
                                        struct player *pplayer,
                                        const struct requirement *preq,
                                        const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_utype(char *buf, size_t bufsz,
                           struct player *pplayer,
                           const struct requirement *preq,
                           const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_unitflag(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_uclass(char *buf, size_t bufsz,
                            struct player *pplayer,
                            const struct requirement *preq,
                            const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_ucflag(char *buf, size_t bufsz,
                            struct player *pplayer,
                            const struct requirement *preq,
                            const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_unit_state(char *buf, size_t bufsz,
                                struct player *pplayer,
                                const struct requirement *preq,
                                const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_activity(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_moves(char *buf, size_t bufsz,
                               struct player *pplayer,
                               const struct requirement *preq,
                               const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_veteran(char *buf, size_t bufsz,
                                 struct player *pplayer,
                                 const struct requirement *preq,
                                 const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_hp(char *buf, size_t bufsz,
                            struct player *pplayer,
                            const struct requirement *preq,
                            const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_otype(char *buf, size_t bufsz,
                           struct player *pplayer,
                           const struct requirement *preq,
                           const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_specialist(char *buf, size_t bufsz,
                                struct player *pplayer,
                                const struct requirement *preq,
                                const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_size(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_culture(char *buf, size_t bufsz,
                                 struct player *pplayer,
                                 const struct requirement *preq,
                                 const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_foreign_pct(char *buf, size_t bufsz,
                                     struct player *pplayer,
                                     const struct requirement *preq,
                                     const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_max_tile_total_units(char *buf, size_t bufsz,
                                          struct player *pplayer,
                                          const struct requirement *preq,
                                          const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_max_tile_top_units(char *buf, size_t bufsz,
                                        struct player *pplayer,
                                        const struct requirement *preq,
                                        const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_ai_level(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_terrain_class(char *buf, size_t bufsz,
                                   struct player *pplayer,
                                   const struct requirement *preq,
                                   const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_terrain_flag(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_road_flag(char *buf, size_t bufsz,
                               struct player *pplayer,
                               const struct requirement *preq,
                               const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_extra_flag(char *buf, size_t bufsz,
                                struct player *pplayer,
                                const struct requirement *preq,
                                const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_year(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_cal_frag(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_topo_property(char *buf, size_t bufsz,
                                   struct player *pplayer,
                                   const struct requirement *preq,
                                   const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_wrap_property(char *buf, size_t bufsz,
                                   struct player *pplayer,
                                   const struct requirement *preq,
                                   const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_server_setting(char *buf, size_t bufsz,
                                    struct player *pplayer,
                                    const struct requirement *preq,
                                    const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_age(char *buf, size_t bufsz,
                         struct player *pplayer,
                         const struct requirement *preq,
                         const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_form_age(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_techs(char *buf, size_t bufsz,
                               struct player *pplayer,
                               const struct requirement *preq,
                               const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_future_techs(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_cities(char *buf, size_t bufsz,
                                struct player *pplayer,
                                const struct requirement *preq,
                                const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_terrain_alter(char *buf, size_t bufsz,
                                   struct player *pplayer,
                                   const struct requirement *preq,
                                   const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_city_tile(char *buf, size_t bufsz,
                               struct player *pplayer,
                               const struct requirement *preq,
                               const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_city_status(char *buf, size_t bufsz,
                                 struct player *pplayer,
                                 const struct requirement *preq,
                                 const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_min_latitude(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_max_latitude(char *buf, size_t bufsz,
                                  struct player *pplayer,
                                  const struct requirement *preq,
                                  const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_distance_sq(char *buf, size_t bufsz,
                                 struct player *pplayer,
                                 const struct requirement *preq,
                                 const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_max_region_tiles(char *buf, size_t bufsz,
                                      struct player *pplayer,
                                      const struct requirement *preq,
                                      const char *prefix)
{
...
/*************************************************************//**
 ...
 returns TRUE if success, FALSE if any problem or "Not supported".
*****************************************************************/
static bool req_text_tile_rel(char *buf, size_t bufsz,
                              struct player *pplayer,
                              const struct requirement *preq,
                              const char *prefix)
{
...
/*************************************************************//**
  ...
  pplayer may be nullptr. Note - this file must be updated every time
  a new requirement type or range is defined.

  returns TRUE if success, FALSE if any problem or "Not supported".
  Loading the ruleset should already have filtered out the "Not supported".
*****************************************************************/
                     ...
                     enum rt_verbosity verb, const char *prefix)
{
  ...
  case VUT_COUNTER:
    return req_text_counter(buf, bufsz, pplayer, preq, prefix);

  case VUT_ADVANCE:
    return req_text_advance(buf, bufsz, pplayer, preq, prefix);

  case VUT_TECHFLAG:
    return req_text_techflag(buf, bufsz, pplayer, preq, prefix);

  case VUT_GOVERNMENT:
    return req_text_government(buf, bufsz, pplayer, preq, prefix);

  case VUT_GOVFLAG:
    return req_text_government_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_ACHIEVEMENT:
    return req_text_achievement(buf, bufsz, pplayer, preq, prefix);

  case VUT_ACTION:
    return req_text_action(buf, bufsz, pplayer, preq, prefix);

  case VUT_IMPR_GENUS:
    return req_text_impr_genus(buf, bufsz, pplayer, preq, prefix);

  case VUT_IMPR_FLAG:
    return req_text_impr_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_PLAYER_FLAG:
    return req_text_player_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_PLAYER_STATE:
    return req_text_player_state(buf, bufsz, pplayer, preq, prefix);

  case VUT_IMPROVEMENT:
  case VUT_SITE:
    return req_text_improvement(buf, bufsz, pplayer, preq, prefix);

  case VUT_EXTRA:
    return req_text_extra(buf, bufsz, pplayer, preq, prefix);
  ...
  case VUT_TERRAIN:
    return req_text_terrain(buf, bufsz, pplayer, preq, prefix);

  case VUT_NATION:
    return req_text_nation(buf, bufsz, pplayer, preq, prefix);

  case VUT_NATIONGROUP:
    return req_text_nation_group(buf, bufsz, pplayer, preq, prefix);

  case VUT_STYLE:
    return req_text_style(buf, bufsz, pplayer, preq, prefix);

  case VUT_NATIONALITY:
    return req_text_nationality(buf, bufsz, pplayer, preq, prefix);

  case VUT_ORIGINAL_OWNER:
    return req_text_original_owner(buf, bufsz, pplayer, preq, prefix);

  case VUT_DIPLREL:
    return req_text_diplrel(buf, bufsz, pplayer, preq, prefix);

  case VUT_DIPLREL_TILE:
    return req_text_diplrel_tile(buf, bufsz, pplayer, preq, prefix);

  case VUT_DIPLREL_TILE_O:
    return req_text_diplrel_tile_o(buf, bufsz, pplayer, preq, prefix);

  case VUT_DIPLREL_UNITANY:
    return req_text_diplrel_unit_any(buf, bufsz, pplayer, preq, prefix);

  case VUT_DIPLREL_UNITANY_O:
    return req_text_diplrel_unit_any_o(buf, bufsz, pplayer, preq, prefix);

  case VUT_UTYPE:
    return req_text_utype(buf, bufsz, pplayer, preq, prefix);

  case VUT_UTFLAG:
    return req_text_unitflag(buf, bufsz, pplayer, preq, prefix);

  case VUT_UCLASS:
    return req_text_uclass(buf, bufsz, pplayer, preq, prefix);

  case VUT_UCFLAG:
    return req_text_ucflag(buf, bufsz, pplayer, preq, prefix);

  case VUT_UNITSTATE:
    return req_text_unit_state(buf, bufsz, pplayer, preq, prefix);

  case VUT_ACTIVITY:
    return req_text_activity(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINMOVES:
    return req_text_min_moves(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINVETERAN:
    return req_text_min_veteran(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINHP:
    return req_text_min_hp(buf, bufsz, pplayer, preq, prefix);

  case VUT_OTYPE:
    return req_text_otype(buf, bufsz, pplayer, preq, prefix);

  case VUT_SPECIALIST:
    return req_text_specialist(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINSIZE:
    return req_text_min_size(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINCULTURE:
    return req_text_min_culture(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINFOREIGNPCT:
    return req_text_min_foreign_pct(buf, bufsz, pplayer, preq, prefix);

  case VUT_MAXTILETOTALUNITS:
    return req_text_max_tile_total_units(buf, bufsz, pplayer, preq, prefix);

  case VUT_MAXTILETOPUNITS:
    return req_text_max_tile_top_units(buf, bufsz, pplayer, preq, prefix);

  case VUT_AI_LEVEL:
    return req_text_ai_level(buf, bufsz, pplayer, preq, prefix);

  case VUT_TERRAINCLASS:
    return req_text_terrain_class(buf, bufsz, pplayer, preq, prefix);

  case VUT_TERRFLAG:
    return req_text_terrain_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_ROADFLAG:
    return req_text_road_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_EXTRAFLAG:
    return req_text_extra_flag(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINYEAR:
    return req_text_min_year(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINCALFRAG:
    return req_text_min_cal_frag(buf, bufsz, pplayer, preq, prefix);

  case VUT_TOPO:
    return req_text_topo_property(buf, bufsz, pplayer, preq, prefix);

  case VUT_WRAP:
    return req_text_wrap_property(buf, bufsz, pplayer, preq, prefix);

  case VUT_SERVERSETTING:
    return req_text_server_setting(buf, bufsz, pplayer, preq, prefix);

  case VUT_AGE:
    return req_text_age(buf, bufsz, pplayer, preq, prefix);

  case VUT_FORM_AGE:
    return req_text_form_age(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINTECHS:
    return req_text_min_techs(buf, bufsz, pplayer, preq, prefix);

  case VUT_FUTURETECHS:
    return req_text_future_techs(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINCITIES:
    return req_text_min_cities(buf, bufsz, pplayer, preq, prefix);

  case VUT_TERRAINALTER:
    return req_text_terrain_alter(buf, bufsz, pplayer, preq, prefix);

  case VUT_CITYTILE:
    return req_text_city_tile(buf, bufsz, pplayer, preq, prefix);

  case VUT_CITYSTATUS:
    return req_text_city_status(buf, bufsz, pplayer, preq, prefix);

  case VUT_MINLATITUDE:
    return req_text_min_latitude(buf, bufsz, pplayer, preq, prefix);

  case VUT_MAXLATITUDE:
    return req_text_max_latitude(buf, bufsz, pplayer, preq, prefix);

  case VUT_MAX_DISTANCE_SQ:
    return req_text_distance_sq(buf, bufsz, pplayer, preq, prefix);

  case VUT_MAX_REGION_TILES:
    return req_text_max_region_tiles(buf, bufsz, pplayer, preq, prefix);

  case VUT_TILE_REL:
    return req_text_tile_rel(buf, bufsz, pplayer, preq, prefix);
